...
const Testimonial = () => {
  ...
  return (
    <div className="relative h-[135vh] md:h-[115vh] lg:h-[90vh] md:mt-40 lg:mt-0">
      <div className="md:px-[90px] ">
        <div className="w-full grid grid-rows justify-center text-center">
          ...
          <div className=" md:w-full flex text-center w-[395px] md:px-7 ">
            <p className="lg:text-[48px] md:text-[40px] text-[35px]  text-center font-[Inter]" >What our Customer says about us</p>
          </div>
        </div>
            ...
            <div key={index} className="lg:px-12 md:px-8 px-[16px] ml-8 md:ml-0 md:py-[40px] lg:py-[20px] py-[44px]">
              <div className="relative border w-full md:h-[420px] lg:h-[370px] h-[400px] rounded-md border-black">
                <div className="mb-4 py-[24px] px-[16px]  lg:p-[20px] md:p-[20px]">
                  <p className="text-[16px] font-[Inter] flex text-center">{value.para}</p>
                </div>
